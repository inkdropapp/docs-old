...
[logo]: http://docs.inkdrop.app/icon_w64.png "Logo Title Text 2"`}</code>
        ...
        <div className="column">
          ...
          <p>
            Inline-style:{' '}
            <img src="/icon_w64.png" alt="alt text" title="Logo Title Text 1" />
          </p>

          <p>
            Reference-style:{' '}
            <img src="/icon_w64.png" alt="alt text" title="Logo Title Text 2" />
          </p>
      ...
      <div className="row">
        <div className="sixteen wide column">
          ...
          <p>
            ...
            highlighting for dozens of languages (and not-really-languages, like
            diffs and HTTP headers); to see the complete list, and how to write
            the language names, see the{' '}
            <a
      ...
      <div className="row">
        <div className="sixteen wide column">
          ...
          <p>
            ...
            of GFM and <strong>Inkdrop</strong> supports them.
          </p>
        </div>
      </div>
      <div className="row">
        ...
        <div className="column">
          ...
          <blockquote>
            <p>
              ...
              enough to actually wrap for everyone. Oh, you can <em>put</em>{' '}
      ...
      <div className="row">
        <div className="sixteen wide column">
          ...
          <p>
            ...
            happens. You can view the editor and preview panel side-by-side on
            Inkdrop.
          </p>
