    ...
    return (
      <div className="menu manual-menu">
        ...
        <ul className="article-list">
          ...
          <li>
            <MenuLink to="/manual/managing-tasks-with-status">
              Managing tasks with status
            </MenuLink>
          </li>
          <li>
            <MenuLink to="/manual/synchronizing-in-the-cloud">
          ...
          <li>
            <MenuLink to="/manual/recovering-your-password">
              Recovering your password
            </MenuLink>
          </li>
          <li>
            <MenuLink to="/manual/working-behind-a-corporate-web-proxy">
              Working behind web proxy
            </MenuLink>
          </li>
          <li>
            <MenuLink to="/manual/backing-up-your-data">
              Backing up your data
            </MenuLink>
          </li>
          <li>
            <MenuLink to="/manual/sharing-your-notes-on-the-web">
              Sharing your notes on the web
            </MenuLink>
          </li>
          <li>
            <MenuLink to="/manual/how-to-import-notes-from-evernote">
        ...
        <ul className="article-list">
          <li>
            <MenuLink to="/manual/accessing-data-in-the-cloud">
          ...
          <li>
            <MenuLink to="/manual/plugin-word-count">
              Plugin: Word Count
            </MenuLink>
          </li>
          <li>
            <MenuLink to="/manual/flux-architecture">
              Flux Architecture
            </MenuLink>
          </li>
          <li>
            <MenuLink to="/manual/accessing-the-local-database">
              Accessing the Local Database
            </MenuLink>
          </li>
          <li>
            <MenuLink to="/manual/customizing-the-editor">
