    ...
    return (
      <div className="menu reference-menu">
        <h3 className="ui header">
          ...
          <div className="content">Data Models</div>
        </h3>
        ...
        <h3 className="ui header">
          ...
          <div className="content">Flux Stores</div>
        </h3>
        <ul className="article-list">
          <li>
        ...
        <h3 className="ui header">
          ...
          <div className="content">Flux Actions</div>
        </h3>
        <ul className="article-list">
          <li>
        ...
        <ul className="article-list">
          ...
          <li>
            <MenuLink to="/reference/command-registry">
              CommandRegistry
            </MenuLink>
          </li>
        </ul>
